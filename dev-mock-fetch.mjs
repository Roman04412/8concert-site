...
const sample = {
  records: [
    { id: 'rec0000001', fields: { Title: 'Джазовий вечір з Оркестром Києва', Snippet: 'Атмосферний джазовий концерт у супроводі струнного квартету, який перенесе вас у Нью-Йорк 1950-х років.', Date: '15 серпня', Location: 'Будинок офіцерів, Київ', Category: 'Джаз', Price: '450 грн', Link: 'https://concert.ua/example1', Status: 'Топ' } },
    { id: 'rec0000002', fields: { Title: 'Реквієм Моцарта', Snippet: 'Виконання одного з найвідоміших творів класичної музики у супроводі симфонічного оркестру.', Date: '16 серпня', Location: 'Національна філармонія', Category: 'Класика', Price: '600 грн', Link: 'https://concert.ua/example2' } },
