...
const sample = {
  records: [
    ...
    { id: 'rec0000003', fields: { Title: "Триб'ют Queen: Bohemian Night", Snippet: "Живе виконання найвідоміших хітів гурту Queen у виконанні київського триб'ют-гурту.", Date: 'сьогодні', Location: 'Atlas', Category: 'Трибьюти', Price: '350 грн', Link: 'https://concert.ua/example3' } },
    ...
    { id: 'rec0000006', fields: { Title: "Триб'ют Pink Floyd", Snippet: 'Психоделічне шоу з візуальними ефектами на честь легендарного гурту.', Date: '20 серпня', Location: 'Bel Etage', Category: 'Трибьюти', Price: '500 грн', Link: 'https://concert.ua/example6' } },
