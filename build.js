...
const VENUES = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Головна зала вміщує понад 2000 глядачів, а акустика вважається однією з найкращих в Україні — дерев\'яні панелі навколо сцени, високі стелі й хороша видимість з будь-якої точки залу. Тут проходять концерти зірок і гуртів, а також театральні постановки — від класичного балету до сучасних мюзиклів.',
    ],
    pros: ["Одна з найкращих акустичних зал України", "Історична будівля 1843 року в самому центрі", "Хороша видимість сцени з будь-якої точки залу"],
    cons: [
      'Велика зала (понад 2000 місць) — формат масштабного концерту, не камерний',
  ...
  },
  {
    ...
    category: 'Готель',
    tagline: 'Перший готель мережі InterContinental в Україні в історичному центрі Києва',
    seoTitle: 'Концерти в InterContinental Kyiv — афіша, адреса',
    metaDescription: 'Концертні та культурні події в готелі InterContinental Kyiv на Великій Житомирській — першому проєкті мережі в Україні, відкритому 2009 року біля Софійської площі.',
    paragraphs: [
      'Готель відкрили 2009 року — це перший проєкт мережі InterContinental в Україні, за проєктом архітектора Сергія Бабушкіна. 13-поверхова будівля (2 з них підземні) на 272 номери позиціонується як приклад "модерн-класичного" стилю, вписаного в історичну забудову старого міста.',
      'Сьогодні це 5-зірковий готель, який використовують для банкетних і конференц-заходів неподалік Софійської та Михайлівської площ у самому центрі.',
    ],
    pros: ['Перший проєкт мережі InterContinental в Україні', 'Локація в історичному центрі біля Софійської та Михайлівської площ', "Архітектура, вписана в стару забудову міста"],
    cons: [
      "Це готельний банкетний простір, а не спеціалізована концертна зала",
