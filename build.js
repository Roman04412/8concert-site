...
const VENUES = [
  ...
  },
  {
    ...
    category: 'Готель',
    tagline: 'Готель у 26-поверховому комплексі H-Tower на бульварі Шевченка',
    seoTitle: 'Концерти в Hilton Kyiv — афіша, адреса',
    metaDescription: 'Концертні та культурні події в готелі Hilton Kyiv на бульварі Тараса Шевченка — у багатофункціональному комплексі H-Tower, відкритому 2014 року.',
    paragraphs: [
      'Рішення про бренд Hilton ухвалили 2006 року; 26-поверховий проєкт розробила компанія "Сіферт-Київ" на чолі з Джоном Сіфертом. Будівництво почалось наприкінці 2006-го, у липні 2011-го будівля досягла максимальної висоти, а готель офіційно відкрили 27 березня 2014 року. Комплекс складається з 25-поверхової центральної вежі та двох 16-поверхових крил — 262 номери із системою "розумний дім".',
      'Сьогодні це 5-зірковий готель, який використовують для конференц-заходів і банкетів на бульварі Тараса Шевченка.',
    ],
    pros: ['Сучасний 26-поверховий комплекс H-Tower', 'Центральне розташування на бульварі Шевченка', "Номери з системою «розумний дім»"],
    cons: [
      "Це готельний конференц-простір, а не спеціалізована концертна зала",
      "Формат і афіша подій залежать від конкретного заходу — варто уточнювати заздалегідь",
    ],
