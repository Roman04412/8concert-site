...
const VENUES = [
  ...
  {
    slug: 'spilka-kompozytoriv',
    name: 'Національна спілка композиторів України',
    image: 'spilka-kompozytoriv.png',
    category: 'Творча спілка',
    tagline: 'Майданчик найбільших фестивалів сучасної академічної музики України',
    seoTitle: 'Концерти в Національній спілці композиторів України — афіша',
    metaDescription: 'Камерні концерти та фестивалі сучасної академічної музики в Національній спілці композиторів України на Пушкінській — зокрема щорічний "Київ Музик Фест".',
    paragraphs: [
      'У будівлі на Пушкінській з 1960-х років розміщується правління Спілки композиторів України та видавництво "Музична Україна" — заклад, що десятиліттями формує академічне музичне життя країни.',
      'Концертна зала Спілки — головний майданчик найбільших фестивалів сучасної академічної та авангардної музики в Україні, зокрема щорічного "Київ Музик Фесту", а також камерних концертів.',
    ],
    pros: ['Головний майданчик сучасної академічної музики в Україні', 'Щорічний фестиваль "Київ Музик Фест"', 'Камерна, зосереджена атмосфера для поціновувачів'],
    cons: [
      'Формат орієнтований радше на сучасну й авангардну академічну музику, ніж на класичний репертуар',
      "Розклад подій прив'язаний до фестивалів — варто стежити за афішею заздалегідь",
    ],
    address: 'Національна спілка композиторів України, вул. Пушкінська, 32, Київ',
    locationMatch: ['спілка композиторів', 'національна спілка композиторів'],
    setting: 'indoor',
    genres: ['класика'],
  ...
  },
  {
    ...
    paragraphs: [
      'Сучасну будівлю готелю на набережній Дніпра в Подолі звели 2012 року — це новобудова 5-зіркового готелю мережі Fairmont із силуетом, що поєднує риси бароко й класицизму, а не історична пам\'ятка.',
  ...
  },
  {
    ...
    address: "Premier Palace, вул. Ярославів Вал / бул. Тараса Шевченка, 5-7/29, Київ",
