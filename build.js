...
<div class="hero" style="padding-bottom:24px">
  <div class="hero-left">
    ...
    <h1 class="hero-title">Де в Києві слухають музику наживо</h1>
            ...
            <p class="hero-sub" style="margin-top:16px">Дахи бізнес-центрів і готелів, літні тераси та сади, камерні зали філармонії й консерваторії, затишні клуби та паби — для кожного місця ми пишемо плюси й мінуси: акустику, вид, зручність дістатися. Показуємо, які концерти там заплановані найближчим часом; майданчики з афішею на найближчий час — зверху списку.</p>
              </div>
</div>
