...
<div class="hero" style="padding-bottom:24px">
  <div class="hero-left">
    ...
    <h1 class="hero-title">Де в Києві слухають музику наживо</h1>
            ...
            <p class="hero-sub" style="margin-top:16px">Для кожного місця — плюси, мінуси й афіша найближчих концертів; майданчики з подіями найближчим часом підіймаємо на початок списку. Щомісяця — нова програма з класики, неокласики та джазу: оберіть сезон нижче — влітку відкриваються тераси й дахи, взимку концерти переходять у зали.</p>
              </div>
</div>
