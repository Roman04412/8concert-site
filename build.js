...
const SITE = {
  ...
  // TODO: замінете на реальну сторінку 8CONCERT у Facebook, коли вона буде —
...
const VENUES = [
  ...
  },
  {
    ...
    seoTitle: "Тераса Д14З — камерні концерти з видом на історичний Київ",
    metaDescription: 'Камерні концерти класики та джазу на терасі Галереї Д14З з видом на історичний центр Києва. Афіша, плюси й мінуси майданчика.',
    paragraphs: [
      'Тераса Д412З при однойменній галереї — цікава локація для камерних концертів з видом на історичний Київ. Формат тут менш масовий, ніж на великих терасах ТРЦ, тому це хороший варіант для тих, хто шукає інтимнішої атмосфери вечора.',
    ...
    address: 'Галерея Д14З',
    phone: '093 973 3373',
    locationMatch: ['д412', 'd12', 'галерея д412'],
    setting: 'outdoor',
    genres: ['джаз', 'класика'],
    venueType: 'тераса',
  },
